		...
		<section class="FondoParallax">
            <section class="parallax" style="background-image: url(http://127.0.0.1:8000/img/ciudad.jpeg);">
                ...
                <div class="row align-items-center">
                    ...
                    <button class="B Botones col-md-3 offset-md-2  col-sm-12 col-sm-12"><a href="http://127.0.0.1:8000/accedeDoctor/{{ $correo->Correo }}"><p class="icon-user-md" style="font-size: 50px; color:#000;"></p><p style="font-weight: bolder; color: #000;">Doctor</p></a></button>
