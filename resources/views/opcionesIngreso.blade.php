		...
		<section class="FondoParallax">
            <section class="parallax" style="background-image: url(http://localhost:8000/img/fondo7.png);">
                ...
                <div class="row align-items-center">
                    <button class="Botones col-md-3 offset-md-2  col-sm-12 col-sm-12 btn btn-success"><a href="{{ Session::get('saludaunclick') }}accedeDoctor/{{ $correo->Correo }}"><p class="icon-user-md" style="font-size: 50px; color:#FFF;"></p><p style="font-weight: bolder; color: #FFF;">Doctor</p></a></button>
